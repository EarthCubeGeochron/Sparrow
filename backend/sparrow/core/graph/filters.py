...
def create_input_filter_field(column):
    ...
    fields = OrderedDict()
    fields["eq"] = Field(
        graphene_type.__class__, description="Field should be equal to given value"
    )
    fields["ne"] = Field(
        graphene_type.__class__, description="Field should not be equal to given value"
    )
    fields["lt"] = Field(
        graphene_type.__class__, description="Field should be less then given value"
    )
    fields["gt"] = Field(
        graphene_type.__class__, description="Field should be great then given value"
    )
    fields["like"] = Field(
