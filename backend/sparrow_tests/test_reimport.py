            ...
            'analysis': [
                {
                    ...
                    'attribute': [
                        {'parameter': 'Crystal termination', 'value': 'double-terminated'},
                    ...
                    'datum': [
                        {
                            ...
                            'type': {'parameter': '4He', 'unit': 'nmol/g', 'error_unit': None}
                        }
                    ],
                    'attribute': []
                }
                    ...
                    'datum': [
                        {
                            ...
                            'type': {'parameter': 'U', 'unit': 'ppm', 'error_unit': None}
                        },
                        {
                            'value': 0.5512344479329546,
                            'error': 0.01146952652671369,
                            'type': {'parameter': 'Th', 'unit': 'ppm', 'error_unit': None}
                        },
                        {
                            'value': 0.0,
                            'error': None,
                            'type': {'parameter': 'Sm', 'unit': 'ppm', 'error_unit': None}
                        }
                    ],
                    'attribute': []
                }
            ...
            'analysis': [
                {
                    ...
                    'datum': [
                        ...
                        },
                        {
                            ...
                            'type': {'parameter': '4He', 'unit': 'ncc', 'error_unit': None}
                        },
                        {
                        ...
                        },
                        {
                            ...
                            'type': {'parameter': 'U', 'unit': 'ng', 'error_unit': None}
                        },
                        {
                            'value': 0.22101808344802518,
                            'error': 0.0045987198015223964,
                            'type': {'parameter': 'Th', 'unit': 'ng', 'error_unit': None}
                        },
                        {
                            'value': 0.0,
                            'error': 0.0,
                            'type': {'parameter': 'Sm', 'unit': 'ng', 'error_unit': None}
                        },
                        {
                    ...
                    'datum': [
                        {
                            ...
                            'type': {'parameter': 'Raw Date', 'unit': 'Ma', 'error_unit': None}
                        },
                        {
                            'value': 2500.624415026046,
                            'error': 59.10134475387011,
                            'type': {'parameter': 'Raw Date It', 'unit': 'Ma', 'error_unit': None}
                        }
                    ],
                    'attribute': []
                },
                    ...
                    'datum': [
                        {
                            ...
                            'error': None,
                            'type': {'parameter': 'alpha-ejection factor', 'unit': 'dimensionless'}
                        },
                        {
