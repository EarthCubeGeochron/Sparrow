...
Understand that Sparrow has a lot to offer labs without them building anything of their own. All labs
need to do is bring the data and our tech stach is built upon the data structures to create
